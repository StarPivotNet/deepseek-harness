...
/**
 * Media written before archivedSessionIds, pinnedSessionIds, hiddenWorkspaceIds,
 * and sessionHomes existed omit the fields; keeping the fixtures in that shape
 * continuously proves the schema defaults upgrade them.
 */
