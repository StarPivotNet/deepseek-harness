...
export type WorkspaceBrowserInjected = {
  ...
  /** Hide a Workspace in the registry-global set. */
  hideWorkspace: (workspaceId: WorkspaceId) => Promise<void>
  /** Show a Workspace from the registry-global hidden set. */
  showWorkspace: (workspaceId: WorkspaceId) => Promise<void>
  /** Append an extra folder to a Workspace. */
  addWorkspaceFolder: (workspaceId: WorkspaceId, path: string) => Promise<void>
  /** Remove an extra folder from a Workspace. */
  removeWorkspaceFolder: (workspaceId: WorkspaceId, path: string) => Promise<void>
